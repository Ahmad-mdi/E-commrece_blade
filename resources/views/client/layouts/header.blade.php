                ...
                <div class="table-container">
                    ...
                    <div class="col-table-cell col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div id="cart">
                            <button type="button" data-toggle="dropdown" data-loading-text="بارگذاری ..." class="heading dropdown-toggle">
                                ...
                                <span id="cart-total">
                                    <span id="total_items">@if(\App\Models\Cart::getItems()) {{\App\Models\Cart::totalItems()}} @else 0 @endif</span>
                                    محصول - <span id="total_price">@if(\App\Models\Cart::getItems()) {{\App\Models\Cart::totalPrice()}} @else 0 @endif
                                    </span> تومان</span>
                            </button>
                    ...
                    <div class="col-table-cell col-lg-3 col-md-3 col-sm-6 col-xs-12 inner">
                        <div id="search" class="input-group">
                            <input autocomplete="off" id="filter_search" type="text" name="search" value="" placeholder="جستجو" class="form-control input-lg" />
                            ...
                            <div class="table-responsive">
                                <h6 class="text-center" style="color: white">تعداد محصول یافت شده:<span id="total_products"></span></h6>
                            </div>
                        </div>
                    </div>
                    <!-- جستجو End-->
